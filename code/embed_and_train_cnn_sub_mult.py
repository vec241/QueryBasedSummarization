...
tf.flags.DEFINE_string("model", "cnn_att_sub_mult", "Specify which model to use") #cnn_att_sub_mult, cnn_att_comp_agr baseline_concat_nn_embed , baseline_sub_mult_nn_embed, cnn_attention

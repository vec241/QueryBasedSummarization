'''
Code for the first baseline model implemented (cf report) : bilinear product between
continuous bag-of-word (CBOW) vectors of paragraph p and question p.
OPTIONAL additional to do --> ADD MLP ON TOP OF BILINEAR PRODUCT
'''
...
class Model(object):
    ...
    def __init__(self, num_classes, vocab_size, embedding_size, max_length, vocab_proc, filter_sizes, num_filters,
        ...
        # OPTIONAL : keeping track of l2 regularization loss
        ...
        with tf.name_scope("output"):
            ...
            # Need to do a lot of reshapes since tensorflow does not manage broadcasting (for the moment)
        ...
        # Random stuff to print for debugging and delete later
    ...
    def embed_CBOW(self, input_indices, input_emb):
        """
        Create CBOW (continuous bag-of-words) embedding of input of size batch_size * max_length

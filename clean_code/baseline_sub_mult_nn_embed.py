"""
Code for the third baseline model implemented (cf report) : MLP over the concatenation of
p and q square point wise difference and point wise multiplication,
where p and q are the continuous bag-of-word (CBOW) vectors of paragraph p and question p.
"""
...
class Model(object):
    """
    Implements a MLP on a vector a where a is the concatenation
